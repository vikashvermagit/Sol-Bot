    ...
    <>
      <div className="h-[360px] overflow-hidden overflow-y-scroll overflow-x-scroll custom-scrollbar">
        <table className="w-[100%] border-collapse leading-7">
          <thead className="">
            <tr className="text-[#858686] leading-3  border-t-[0.5px] border-[#515151] bg-[#121212] h-[45px] text-[16px] font-bold">
          ...
          <tbody className="font-bold">
            <tr className="leading-6 cursor-pointer  bg-[#171717] h-[70px]">
              <td className=" text-left p-1 px-4 whitespace-nowrap text-white text-[16px] font-bold uppercase gap-1">
              ...
              <td className=" text-left p-1 px-4 whitespace-nowrap text-white text-[16px] font-bold">
              ...
              <td className=" text-left p-1 px-4 whitespace-nowrap text-white text-[16px] font-medium  uppercase">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <p className="font-bold text-[16px]">21</p>
                </div>
              </td>
              ...
              <td className=" text-left p-1 px-4 whitespace-nowrap text-white">
                <div>
                  <p className="font-bold text-[16px] text-[#17C654]">32.12%</p>
                </div>
              </td>
              <td className=" text-left p-1 px-4 whitespace-nowrap">
                <div className="flex items-center gap-2">
                  <Image
                    ...
                    className="w-[18px] h-[18px]"
                  />
                  <p className="font-bold text-[16px] text-[#17C654]">+0.2</p>
                </div>
              </td>
            ...
            <tr className="leading-6 cursor-pointer  bg-[#0F0F0F] h-[70px]">
              ...
              <td className=" text-left p-1 px-4 whitespace-nowrap text-white text-[16px] font-bold">
                <p className="font-bold text-[16px]">30 mins</p>
              </td>
              <td className=" text-left p-1 px-4 whitespace-nowrap text-white text-[16px] font-medium  uppercase">
                <div className="flex items-center gap-2">
                  <Image
              ...
              <td className=" text-left p-1 px-4 whitespace-nowrap text-white">
                <div className="flex items-center gap-2">
                  <Image
                    ...
                    className="w-[18px] h-[18px]"
                  />
                  <p className="font-bold text-[16px]">6.7</p>
                </div>
              </td>
              <td className=" text-left p-1 px-4 whitespace-nowrap text-white">
                <div>
                  <p className="font-bold text-[16px] text-red-500">32.12%</p>
                </div>
              </td>
              <td className=" text-left p-1 px-4 whitespace-nowrap">
                <div className="flex items-center gap-2">
                  <Image
                    ...
                    className="w-[18px] h-[18px]"
                  />
                  <p className="font-bold text-[16px] text-red-500">-0.2</p>
                </div>
              </td>
