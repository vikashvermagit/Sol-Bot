        ...
        <div className='bg-[#171821] rounded-md  mx-auto p-5 w-[700px] border'>
            ...
            <div className='flex justify-around mx-auto gap-3 mt-2'>
                <div className='bg-[#0F0F0F] border border-[#7A7A7A] flex justify-between  w-1/2 rounded-[8px] items-center'>
                    <span className='text-[#7A7A7A] text-base font-medium rounded-l-[8px] ml-3'>Min</span>
                    <div className='border-l-2 '></div>
                    <input type="text" className=" text-white bg-transparent border-none hover:border-none py-1  " />
                    <span className='text-[#7A7A7A] text-base font-medium bg-[#303030] p-2 rounded-r-[8px]'>hours</span>
                </div>

                <div className='bg-[#0F0F0F] border border-[#7A7A7A] flex justify-between  w-1/2 rounded-[8px] items-center'>
                    <span className='text-[#7A7A7A] text-base font-medium rounded-l-[8px] ml-3'>Max</span>
                    <div className='border-l-2 '></div>
                    <input type="text" className=" text-white bg-transparent border-none hover:border-none py-1  " />
                    <span className='text-[#7A7A7A] text-base font-medium bg-[#303030] p-2 rounded-r-[8px]'>hours</span>
                </div>
            ...
            <div className='flex justify-around mx-auto gap-3 mt-2'>
                <div className='bg-[#0F0F0F] border border-[#7A7A7A] flex justify-between  w-1/2 rounded-[8px] items-center'>
                    ...
                    <div className='border-l-2 '></div>
                    <input type="text" className=" text-white bg-transparent border-none hover:border-none py-1  " />
                    <span className='text-[#7A7A7A] text-base font-medium bg-[#303030] p-2 rounded-r-[8px]'>%</span>
                </div>
