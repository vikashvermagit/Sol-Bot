        ...
        >
            ...
            <div
                ...
                style={{
                    width: '28px',
                    height: '28px',
                    top: '25vh',  // Adjusted for relative positioning
                    left: '15vw',  // Adjusted for relative positioning
                }}
            >
            ...
            <div className='flex justify-center relative z-10'>
                <div className='mt-[105px] px-6 sm:px-12 md:px-24 w-full max-w-[1048px]'>
                    <h1 className='text-[32px] sm:text-[40px] md:text-[55px] text-center font-bold text-white'>
                        Trade Smarter With Blockbit Solana Sniper Bot
                    </h1>
                    <h1 className="text-[20px] mt-[20px] sm:mt-[28px] md:mt-[36px] flex justify-center font-normal bg-clip-text text-transparent bg-gradient-to-r from-[#2593F9] via-[#2593F9] to-[#00FFD1]">
            ...
            <div className="flex flex-col lg:flex-row justify-between px-[20px] sm:px-[30px] md:px-[50px] lg:px-[169px] items-start text-left mt-[50px] md:mt-[150px] lg:mt-[328px] relative z-10">
                <div className="w-full max-w-[466px] mx-auto text-start lg:text-left mb-8 lg:mb-0">
                    <h1 className="text-[20px] font-normal text-[#989898]">01.</h1>
                    <h1 className="text-[48px] font-normal text-white">
                        Auto Scan
                    </h1>
                    <p className="text-[20px] font-normal text-[#989898]">
                        Scan the Solana blockchain and discover new tokens based on your filters
                    </p>
                    <div className="relative inline-block mt-[20px] sm:mt-[24px] md:mt-[36px] p-[3px] rounded-[48px] bg-gradient-to-r from-[#0C4D69] to-[#18B18C]">
                        <button className="flex items-center justify-center gap-2 px-[48px] py-[23px] rounded-[48px] text-white text-[20px] font-bold bg-[#171717] w-full h-full">
            ...
            <div className=' relative z-10 mt-[120px] pb-32'>
                <div className='flex justify-center'>
                    <div className='mt-[105px] px-2 sm:px-24 w-[1048px]'>
                        <h1 className='text-[24px] sm:text-[36px] md:text-[48px] text-center font-normal text-white'>
